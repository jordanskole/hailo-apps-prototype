...
Usage:
    ...
    python -m hailo_agent.agent --state optimized_v2

    # Debug mode
    python -m hailo_agent.agent --debug
"""
...
# Core imports
from hailo_agent.core.utils import (
    get_standalone_parser,
    handle_list_models_flag,
    resolve_hef_path,
)
from hailo_agent.core.defines import (
    AGENT_APP,
    HAILO10H_ARCH,
    SHARED_VDEVICE_GROUP_ID,
    WHISPER_CHAT_APP,
)
from hailo_agent.core.logger import (
    get_logger,
    init_logging,
    level_from_args,
)
...
from hailo_agent.voice.vad import add_vad_args
...
class AgentApp:
    ...
    def _init_voice_components(self, whisper_hef_path: Optional[Path]) -> None:
        ...
        try:
            from hailo_agent.voice.speech_to_text import (
                SpeechToTextProcessor,
            )
            from hailo_agent.voice.text_to_speech import (
    ...
    def _run_voice_loop(self) -> None:
        ...
        """
        try:
            from hailo_agent.voice.interaction import (
