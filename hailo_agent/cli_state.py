...
Usage:
    python -m hailo_agent.cli_state math list
    python -m hailo_agent.cli_state math delete default
    python -m hailo_agent.cli_state math info optimized_v2
    python -m hailo_agent.cli_state math best
"""
