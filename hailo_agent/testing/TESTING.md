...
# Test tool parsing
python -c "from hailo_agent.llm import tool_parsing; \
...
python -m hailo_agent.testing.runner math

# Test with debug flag
python -m hailo_agent.agent --tool math --debug

# Test voice mode with debug
python -m hailo_agent.agent --tool math --voice --debug
```
...
```python
from hailo_agent.llm.streaming import StreamingTextFilter
...
```python
from hailo_agent.testing.harness import AgentTestHarness
