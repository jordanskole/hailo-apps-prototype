...
Usage:
    ...
    python -m hailo_agent.testing.runner math --quick

    # Filter by tags
    python -m hailo_agent.testing.runner math --tags basic

    # Save results
    python -m hailo_agent.testing.runner math --output results.json
"""
