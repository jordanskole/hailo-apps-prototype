...
from hailo_agent.llm.terminal_ui import TerminalUI
from hailo_agent.voice.audio_recorder import AudioRecorder
from hailo_agent.voice.vad import VoiceActivityDetector
from hailo_agent.core.defines import TARGET_SR, CHUNK_SIZE
